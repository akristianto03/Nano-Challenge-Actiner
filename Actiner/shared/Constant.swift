...
//  ezitinerary
//
//  Created by Alfredo Junio on 08/05/22.
//
...
let primaryC = Color("5639BF")
let secondC = Color("ED6B6B")

let blueC = Color("00B5BF")
let yellowC = Color("F7D336")
let greenC = Color("5AC41D")

let blackC = Color("121212")
